...
MODEL                  = power_PVarray_grid_det
MODULES                = power_PVarray_grid_det_capi.c power_PVarray_grid_det_data.c power_PVarray_grid_det_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c 
MAKEFILE               = power_PVarray_grid_det.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2016b
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2016b
MATLAB_ROOTQ           = \"/usr/local/MATLAB/R2016b\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/oka/files/ucm/tfg/src
S_FUNCTIONS            = rtiostream_utils.c sfun_discreteVariableDelay.c
...
COMPUTER               = GLNXA64
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/usr/local/MATLAB/R2016b" EXT_MODE=1 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC -DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
...
MODELLIB                  = power_PVarray_grid_detlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/power_PVarray_grid_det \
	-I$(START_DIR) \
	-I/home/oka/files/ucm/tfg/workspace \
...
ifeq ($(MODELREF_TARGET_TYPE), NONE)
    ...
    REQ_SRCS = $(MODEL).c $(MODULES) $(EXT_SRC) \
       raccel_sup.c raccel_mat.c simulink_solver_api.c common_utils.c raccel_utils.c raccel_sfcn_utils.c 
    ifneq ($(ENABLE_SLEXEC_SSBRIDGE), 0)
